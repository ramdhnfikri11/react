...
let Home = (props) =>{
    return(
        ...
        <Navbar expand="lg" className="navbar">
                <Navbar.Brand href="#" className='navbar-brand'>React</Navbar.Brand>
                ...
                <Navbar.Collapse id="navbarScroll">
                    ...
                    >
                        ...
                        <Nav.Link className='nav-link-2' href="#action4">V18.2.0</Nav.Link>
                        <Nav.Link className='nav-link-2' href="#action5">Language</Nav.Link>
                        <Nav.Link className='nav-link-2' href="#action3">Github</Nav.Link>
                    </Nav>
                </Navbar.Collapse>
        </Navbar>
